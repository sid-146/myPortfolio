...
3. **Resume PDF in Public Folder**: Ensure your PDF resume is placed at:  
   ...
   _(The resume download buttons link directly to this file)._
...
_(Note: You can deploy from either `main` or `dev` — you can choose your production branch in Vercel's settings)._
...
3. Under **Import Git Repository**, look for `sid-146/myPortfolio`.
    - _If it doesn't appear, click "Adjust GitHub App Permissions" and grant Vercel access to the `myPortfolio` repository._
...
_(If you later add analytics tokens like Google Analytics `NEXT_PUBLIC_GA_ID`, you can paste them here)._
